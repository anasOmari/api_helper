...
Future<Map<String, dynamic>> fetchDataWithQuery(String endpoint, Map<String,String> queryParams) async{
...
Future<Map<String, dynamic>> editData(String endpoint, Map<String,dynamic> data)async{
  final Uri url =Uri.parse('$rootApi$endpoint');
